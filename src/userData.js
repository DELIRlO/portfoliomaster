const userData = {
  ...
  about: 'Olá, eu sou o Carlos Filho! Engenheiro de Computação com foco em desenvolvimento de sistemas e programas. Tenho 39 anos e sou de Belém/PARÁ. Meus interesses são programação e leitura de dados.',
  skills: [
    'HTML/CSS',
    'JavaScript',
    'Python',
  ...
  projects: [
    ...
    },
    {
      ...
      description: 'Cronômetro digital muito útil para adicionar vários alarmes para o dia a dia.',
      technologies: ['Python'],
